...
const PostDetails = () => {
  ...
  //get creater id of post
  const creator = post?.post?.author?._id?.toString();

  //get login id of logged in user
  const loggedInUser = userAuth?.userInfo?.id?.toString();

  //check wheter logged in user is cretor of post or not.
    ...
    <>
      {loading ? (
        ...
        >
          ...
          {/* <img className="w-full mx-auto mb-4 " src={post?.post?.image} /> */}
